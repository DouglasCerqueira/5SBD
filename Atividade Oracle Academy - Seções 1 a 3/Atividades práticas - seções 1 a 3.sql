...
SELECT cliente_cod, cliente_nome FROM cliente 
...
WHERE saldo > 9000 ORDER BY saldo DESC;
...
SELECT ROUND(saldo, 0) AS saldo_arredondado FROM conta;

-- 12. Exiba o nome de todos os clientes em letras maiúsculas.

SELECT UPPER(cliente_nome) AS nome_maiusculo FROM cliente;
